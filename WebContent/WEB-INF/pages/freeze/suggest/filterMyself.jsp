...
<div class="crumb">
	<div class="addsuggest-title">我的反馈信息</div>
	<div class="backNav"><a href="action/global/manager">返回管理首页</a></div>
	<div class="clear"></div>
</div>
<div class="quick-action">
	<a href="action/suggest/viewAddMyself" class="button-like"><span class="add-suggest">反馈信息对系统的意见或所发现的问题</span></a>
</div>
<div class="box">
			...
			<form action="action/suggest/batchDeleteMyself">
				...
				<table class="dataTable">
					...
					<tr>
						...
						<td>
							<a href="action/suggest/showMyself?id=${suggest.id }" title="查看此反馈信息详细" class="detail-suggest">
							<c:choose>
