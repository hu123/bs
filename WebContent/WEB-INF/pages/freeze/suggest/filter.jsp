...
<body>
	...
	<div class="crumb">
		<div class="addsuggest-title">反馈信息</div>
		<div class="backNav">
			...
			<c:otherwise>
				...
				<table class="dataTable">
					...
					<c:forEach var="suggest" items="${dataList }">
						<tr>
							<td><a href="action/suggest/show?id=${suggest.id }" title="查看此反馈信息详细"
							...
							<td>
								<c:choose>
									<c:when test="${suggest.replyUserID == 0 }">
										<a href="action/suggest/viewModify?id=${suggest.id }" class="replyto">回复此反馈信息</a>
									</c:when>
									<c:otherwise>
