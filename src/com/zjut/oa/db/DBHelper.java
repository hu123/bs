...
public final class DBHelper
{
	...
	public static Connection getConnection()
	{
		...
		{
			throw new RuntimeException("Can't get a connection in DBHelper!" + e);
		}
	}
	...
	public static <T> T read(Class<T> beanClass, String sql, Object... params)
	{
		try
		{
			...
			return (T) qRunner.query(getConnection(), sql,
					isPrimitive(beanClass) ? scaleHandler : new BeanHandler<T>(beanClass), params);
		}
		catch (SQLException e)
		{
	...
	public static <T> List<T> query(Class<T> beanClass, String sql, Object... params)
	{
		...
		{
			throw new RuntimeException("Can't invoke query(Class<T> beanClass,String sql,Object ...params)" + e);
		}
	}
	...
	{
		if (page < 0 || count < 0)
			throw new IllegalArgumentException("Illegal parameter of 'page' or 'count'");
		int from = (page - 1) * count;
		count = (count > 0) ? count : Integer.MAX_VALUE;
		log.debug("querySlice: " + sql + ",page: " + page + ",from: " + from + ",count: " + count);
	...
	public static long stat(String sql, Object... params)
	{
		...
		{
			log.debug("stat: " + sql);
			Number num = (Number) qRunner.query(getConnection(), sql, scaleHandler, params);
			return (num != null) ? num.longValue() : -1;
		}
		catch (SQLException e)
		{
			throw new RuntimeException("Can't invoke stat(String sql,Object ...params)" + e);
		}
	}
